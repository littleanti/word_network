export const WORDS = [
  ...
  {id:'meadow_wind', word:'바람', syllables:['바','람'], category:'자연', sceneId:'meadow', emoji:'🌬️', hint:'눈에 안 보이지만 느껴요', hotspot:{x:0.20,y:0.30,r:0.10}},
  {id:'sky_sky', word:'하늘', syllables:['하','늘'], category:'자연', sceneId:'sky', emoji:'🌤️', hint:'위를 올려다봐요', hotspot:{x:0.50,y:0.20,r:0.15}},
